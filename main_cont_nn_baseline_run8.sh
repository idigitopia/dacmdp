...
EnvNames=("halfcheetah-expert-v0"
	"hopper-expert-v0"
	"walker2d-expert-v0"
...
for env_name in ${EnvNames[*]}; do
{
    for tran_type_count in $TranTypeCounts; do
    {
        ...
        --wandb_project d4rl_dac --wandb_entity dacmdp --wandb_id MCNB-100K-DD${env_name}-Rtd3_bc-TT${tran_type_count}-P${penalty_beta}-K${mdp_build_k}-S${seed} \
